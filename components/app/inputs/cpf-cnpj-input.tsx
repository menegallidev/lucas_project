...
import { caretPosFromDigitIndex, formatCpfCnpj, onlyDigits } from "@/lib/masks";
...
export const CpfCnpjInput = React.forwardRef<HTMLInputElement, Props>(
    ({ value, onChange, name, id, ...props }, ref) => {
        ...
        const formattedValue = React.useMemo(() => formatCpfCnpj(digits), [digits]);
        ...
        const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            const nextDigits = onlyDigits(el.value).slice(0, 14);
            const nextFormatted = formatCpfCnpj(nextDigits);
